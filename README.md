...
The first time running this code provided us with an accuracy of 84.615%. In the confusion matrix, we find out how often our model predicted each label as right or wrong predictions. Diagonal elements represent the accuracy, whereas off-diagonal elements are errors. Furthermore, it can be seen that obstruction and normal classes have been predicted by our model more accurately, whereas a few collision data have been classified as normal class data, and fr-collision class data has been classified as obstruction class. Therefore, it seems like a decent classifier, except that it is difficult to separate obstruction-fr_obstruction and collision-normal classes.

------------------------------------------------------------------------------------------------------------
<img width="2880" height="1800" alt="image" src="https://github.com/user-attachments/assets/7e1f6c7a-8a20-41ee-bbfb-50ac04724853" />
The tuned model did not provide any improvements in the confusion matrix overall. The accuracy rate was 22 out of 26 (84.615%) in the case of our initial model, whereas in the case of the optimized model, the accuracy rate is 19 out of 26 (70.077%). While our tuned model is able to classify the normal category correctly, there is an increase in errors on the part of the tuned model in classifying collisions and obstructions.
